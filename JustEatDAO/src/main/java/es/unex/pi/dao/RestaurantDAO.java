...
public interface RestaurantDAO {
	...
	/**
	 * Gets all the restaurants from the database that contain a text in the name, decription or city.
	 * 
	 * @param search
	 *            Search string .
	 * 
	 * @return List of all the restaurants from the database that contain a text either in the name, description or city.
	 */	
